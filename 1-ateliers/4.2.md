...
3. Mettez en place une route pour récupérer tous les articles (news)
4. Mettez en place une route dynamique pour récupérer un seul article à partir de son ***ID (identifiant)***

---

## Aides et spécifications techniques

- L'application tourne sur le PORT 4200, vous pouvez changer cette information depuis le fichier ***bin/www***
